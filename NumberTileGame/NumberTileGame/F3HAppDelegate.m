...
//    F3HNumberTileGameViewController *vc = [[F3HNumberTileGameViewController alloc]init];
...
//                                                                                       buttonControls:NO
//                                                                                        swipeControls:YES];
//    [self.window.rootViewController presentViewController:c animated:YES completion:nil];
